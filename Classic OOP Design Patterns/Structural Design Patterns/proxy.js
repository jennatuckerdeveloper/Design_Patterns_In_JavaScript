...
*/
var EbookLoader = /** @class */ (function () {
    function EbookLoader() {
        var _this = this;
        this.getEbook = function () {
            return _this.ebook;
        };
        this.ebook = null;
    }
    EbookLoader.prototype.load = function (title, author, coverIMG) {
        if (this.ebook === null) {
            this.ebook = new ProxyEbook(title, author, coverIMG);
        }
    };
    EbookLoader.prototype.open = function () {
        var fullEbook = new FullEbook(this.ebook);
        fullEbook.open();
        this.ebook = fullEbook;
    };
    return EbookLoader;
}());
var ProxyEbook = /** @class */ (function () {
    function ProxyEbook(title, author, coverIMG) {
        this.title = title;
        this.author = author;
